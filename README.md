...
This package contains example JSON files for https://api.github.com/ as well as GitHub Enterprise Versions in the [payload-examples/](payload-examples/) folder. Whenever a JSON file changes, the definition files can be uploaded by running `node bin/octokit-webhooks update`

This package updates itself using a daily cronjob running on Travis. The
[`index.json`](index.json) file is
